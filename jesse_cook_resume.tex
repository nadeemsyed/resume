...
\begin{ncolumn}{4}
   \setlength\parsep{15pt}
   \small Budgeting Software & \small Android SDK     & \small AI Toolset  & \small Mini-ITX Firewall \\
   \small Loan Analysis Tool & \small Libvirt Patches & \small MTG Toolset & \small Aufs Sandbox \\
\end{ncolumn}
